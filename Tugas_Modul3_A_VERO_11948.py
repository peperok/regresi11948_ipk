...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1948</h1>", unsafe_allow_html=True)  # XXXX = 4 digit npm terakhir
...
if uploaded_file is not None:
    ...
    model_directory = r'"D:\UAJY\UAJY_sem_5\ML\ML4\Supervised Learning (Praktek)\Tugas3_A_11948"'
